...
-- DBTITLE 1,Create v_driver_standing view
CREATE OR REPLACE VIEW gold.v_driver_standing
AS
...
-- DBTITLE 1,Query v_driver_standing
SELECT * FROM gold.v_driver_standing WHERE season = 2025